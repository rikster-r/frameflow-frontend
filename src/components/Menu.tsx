  ...
  return (
    <div className="relative mt-auto w-full">
      ...
      <AnimatePresence mode="wait">
        {isOpen && (
          <motion.div
            className="absolute bottom-12 w-[250px] rounded-md bg-white shadow-md dark:bg-neutral-800"
          ...
          >
            <Link
              href={`/${username}/edit`}
              className="flex items-center border-b border-neutral-300 px-4 py-3 dark:border-0"
            >
            ...
            <button
              className="flex w-full items-center border-b border-neutral-300 px-4 py-3 dark:border-0"
            ...
            <button className="flex w-full items-center px-4 py-3">
